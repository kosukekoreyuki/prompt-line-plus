...
## [0.2.0](https://github.com/kosukekoreyuki/prompt-line-plus/compare/prompt-line-plus-v0.1.0...prompt-line-plus-v0.2.0) (2026-05-30)


### Features

* **agent-label:** add label display to agent suggestions ([6332c7b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6332c7b4c22706c4633db635dcd5cdff5fbfa38e))
* **agent-skills:** add icon support with auto-detection from pattern ([4ffcdf0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4ffcdf0c9592304f931d9add753013a1a3a4bc7a))
* **agent-skills:** implement multi-keyword AND search for slash commands ([0685221](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0685221d238d3fbf0f29ee792cc2b26d4dd155f9))
* **agent-skills:** support $ trigger prefix for highlight and backspace deletion ([d2e4993](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d2e4993ee471e9785c6af7cd09f4253d1e732820))
* **agents:** add color support for agents with template resolution ([0559467](https://github.com/kosukekoreyuki/prompt-line-plus/commit/05594673f785dd2b290605a4924321abbf8b5630))
* **agentSkills:** rename slashCommands to agentSkills and add template variables ([4bd2025](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4bd2025b935fc35fc778f7cdb25e6dac2a51cdda))
* **built-in-commands:** add new commands and update descriptions for Claude, Codex, and Gemini ([cbb9c02](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cbb9c02d5dcb30769b30f8055e3aad5231370fe2))
* **built-in-commands:** update Claude, Codex, and Gemini slash commands to latest ([e812b1b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e812b1bd3533c5427aef52dca028ad11b3373951))
* **ci:** enable always-bump-patch versioning strategy ([8014389](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8014389d4bbb85e4637037d5d86e14440d66da50))
* **colors:** expand color palette to 20 named colors ([8b83892](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8b83892fd22f937a660c0fe8ab41113ae7ce226f))
* **commands:** add batch and simplify built-in commands ([f2d18b9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f2d18b9f43aa5c82061deaf6d8a7957ecbc62b74))
* **config:** add imageDirectory setting for custom image storage ([#324](https://github.com/kosukekoreyuki/prompt-line-plus/issues/324)) ([ef8cf36](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ef8cf36d8a2f8a2d3ac9349eb989685d9f2aa5bf))
* **config:** add language_backend configuration option to project.yml ([6439285](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6439285755e76717c7b589c8b2b49e71c075c9ca))
* **config:** add opencode to built-in commands examples ([9211ecc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9211ecc0d863b864edbf12312cf330e70d37206f))
* custom search enhancements, agent skills rename, Tailwind CSS integration, and color palette expansion ([13ca207](https://github.com/kosukekoreyuki/prompt-line-plus/commit/13ca207dcbaf07326a73ba720ab3f1e42799d063))
* **custom-search:** add {content} and {filepath} template placeholders for inputFormat ([9f71937](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9f71937da04450113b684992557c62101b1041ba))
* **custom-search:** add command stdout as search source ([#313](https://github.com/kosukekoreyuki/prompt-line-plus/issues/313)) ([20c7e02](https://github.com/kosukekoreyuki/prompt-line-plus/commit/20c7e0266aa3fa9195d70cb9cf5a75de2b6ad84a))
* **custom-search:** add Ctrl+Enter command execution for custom search items ([04da505](https://github.com/kosukekoreyuki/prompt-line-plus/commit/04da505e04ec99185f2310a79fcbd3dbe04445b7))
* **custom-search:** add icon support for slash commands and agents ([e4add67](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e4add6716bd3795089fce4f36a3474030ea00f72))
* **custom-search:** add jsonArrayPath support for expanding JSON arrays into multiple items ([05cae9d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/05cae9d49b5e0df331e43be60ca9ef08c43c50ef))
* **custom-search:** add line-by-line parsing for plain text files ([b4c56c7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b4c56c70132661c9a712005cc82defcf8c2dfcf7))
* **custom-search:** add plain text file support ([793b23f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/793b23f7cf37a57205c57facdbfe330ccd1c0ee2))
* **custom-search:** open inputText path/URL with Ctrl+Enter instead of source file ([ccb6b02](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ccb6b02c0d0c63acc67f9ad74356157a169c1d6e))
* **custom-search:** preserve plain text item line order instead of sorting by name ([59ba119](https://github.com/kosukekoreyuki/prompt-line-plus/commit/59ba11983208294fcac8d508869ce27173e7e3ea))
* **custom-search:** replace jsonArrayPath with jq expression syntax in pattern ([01d0dac](https://github.com/kosukekoreyuki/prompt-line-plus/commit/01d0dacc223b2cdcc3ed8f92ef08e5335ec08dbf))
* **custom-search:** support custom field sorting in orderBy ([11aaf70](https://github.com/kosukekoreyuki/prompt-line-plus/commit/11aaf70eb0df6b7654dd7d8a5debf9c9d29a5500))
* **custom-search:** support label-based deduplication for commands and items ([5b42aa9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5b42aa9681a4c973cbcbfe7e46541eae32e19d15))
* **directory-detector:** support cmux.app terminal ([#370](https://github.com/kosukekoreyuki/prompt-line-plus/issues/370)) ([4e07d4e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4e07d4e1e2f2ce519551744c1621004720a48567))
* **displayTime:** flexible timestamp normalization for custom search ([#356](https://github.com/kosukekoreyuki/prompt-line-plus/issues/356)) ([3b721da](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3b721daaf18862de5f00dec00bbc27ee2a6b39e6))
* **excludeIf:** add template-based item exclusion for plugin entries ([#360](https://github.com/kosukekoreyuki/prompt-line-plus/issues/360)) ([98a288c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/98a288c9d427edd5917f2de55bb8e90c0d4835df))
* **file-opener:** add directory-specific default editor with glob support ([9c7c0d0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9c7c0d0462b00e1768108cc48c3498ab40182b42))
* **history:** add iTerm2 session ID to history entries ([#301](https://github.com/kosukekoreyuki/prompt-line-plus/issues/301)) ([4b68f8b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4b68f8b1a8d3ee5d12b253413dd9e8a45ea9376c))
* **icons:** add icon property support for slash commands and mentions ([38fbad5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/38fbad504e4c4765f01e7c6f95e34ddc72cf5a96))
* **input:** add feature guidance to input placeholder ([69b3b54](https://github.com/kosukekoreyuki/prompt-line-plus/commit/69b3b548fada82c0ad7d337d81d261fdbfe1b122))
* **inputFormat:** support template-based formatting for custom search items ([c23f97f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c23f97f1ad91a4581a3cfcc27b13cb9688711f82))
* **md-search-loader:** add dirname to template context ([8779a03](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8779a03806ccca056c726954718b109faa7767aa))
* **mentions,settings:** add icon support for custom search entries ([a40c653](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a40c6534739efff0e61d548637a65f139fd5a328))
* **mentions:** add color property support to custom search entries ([049447c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/049447c5e37068b0f47a740170443285fc457001))
* **mentions:** add label support to mention entries ([a32af4a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a32af4a7ad5953535c656530fd17996e34faf9b9))
* **mentions:** implement multi-keyword AND search for files and agents ([b981a5c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b981a5cb8d4b00af8c80229f103b6edb3c85804b))
* **plugins:** add plugin-based search source management ([#286](https://github.com/kosukekoreyuki/prompt-line-plus/issues/286)) ([1c56057](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1c56057bce3da4ecaf3904044e13cf5fbec5ab8b))
* **plugins:** add pluginDescription field and show as comments in install output ([#288](https://github.com/kosukekoreyuki/prompt-line-plus/issues/288)) ([4e2a9a1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4e2a9a16fe34ccc695a676ad6da85ded65a6e6a1))
* **plugins:** plugin system v2 with GitHub repo-based install ([#303](https://github.com/kosukekoreyuki/prompt-line-plus/issues/303)) ([3bf5265](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3bf526514a0dc0266fdfafefe6236eddd33234bd))
* **plugins:** support local repos without remote origin ([802c75a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/802c75a8eaefa1f2db37eb237f610f2c2f9c2fbe))
* **plugins:** support skills, agents, and references in agent-built-in YAML ([#310](https://github.com/kosukekoreyuki/prompt-line-plus/issues/310)) ([071d21a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/071d21a178907645754cf0c7a552424904343485))
* **plugins:** unify plugin CLI and support local repos ([cf55ee1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cf55ee16f27eb3c4a5a2a9a44bf835c8b86c4e78))
* **plugins:** unify plugin commands into single CLI entry point ([5467dfc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5467dfc513c427e056c16317f82e411b57051a46))
* **plugin:** use YAML file directory as cwd for sourceCommand/runCommand ([#341](https://github.com/kosukekoreyuki/prompt-line-plus/issues/341)) ([43a4608](https://github.com/kosukekoreyuki/prompt-line-plus/commit/43a46087748ca53c67b29c0768c0d08f30459892))
* **renderer:** add bullet-list auto-formatting (Tab/Enter) ([f4f029b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f4f029b2760e7cc094898407a765ad88c1b71a77))
* **search:** add AND search support for symbol search, custom search, and slash commands ([a7f3d61](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a7f3d612372f3195ac8cfbe9393f721ca207a375))
* **search:** add space-separated AND search for slash commands and mentions ([04b29b2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/04b29b2df225171a39aac74ee73922010990f73b))
* **search:** support AND search with space-separated keywords ([7d07868](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7d0786821ac29798a86ef276af056625670188a6))
* **settings:** add folder-based management for agentSkills and customSearch ([#293](https://github.com/kosukekoreyuki/prompt-line-plus/issues/293)) ([3941c7b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3941c7b87c1c4a15afc191212b174f2997291688))
* **settings:** add migrate-settings command for automatic settings migration ([5ee6e9f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5ee6e9fee93cda97c9b4912c72c5acbd8f34e499))
* **settings:** add shortcut field to customSearch entries for direct activation ([500cb0b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/500cb0b0c9bfded3f61605357648e6d906c31df9))
* **shortcuts:** add "run=" action to execute shell commands from settings.yaml ([#377](https://github.com/kosukekoreyuki/prompt-line-plus/issues/377)) ([f28e41b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f28e41b569d3a0ae5f97f656e9fcfd99868c3ed0))
* **shortcuts:** add "run=" action to execute shell commands from settings.yaml ([#380](https://github.com/kosukekoreyuki/prompt-line-plus/issues/380)) ([4768f18](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4768f186c6bf517091a143602126c77b13fe4a5f))
* **shortcuts:** add Ctrl+Shift+Enter to reveal file directory in Finder ([86851f8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/86851f84ce5cf541f42ed5cf77640f74d3000582))
* **slash-commands:** add color fallback syntax and apply colors only to icons ([270bd48](https://github.com/kosukekoreyuki/prompt-line-plus/commit/270bd4829b6e84d4cbd42e487f41847d9532c47f))
* **styles:** integrate Tailwind CSS with Vite plugin ([2628e01](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2628e0168d02ca9f068094e2b264395fcc263948))
* **template-resolver:** add {content} placeholder and fix inputFormat handling ([988aec1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/988aec14e14427aac8c4978894d6b786f35dacee))
* **template-resolver:** add dirname variable support for template resolution ([eda4c29](https://github.com/kosukekoreyuki/prompt-line-plus/commit/eda4c299ce92812a1acc971881858971e7efe0f5))
* **template-resolver:** support hierarchical directory reference with {dirname:N} ([1f0fc45](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1f0fc454a8dc00983417d206c44612761d214807))
* **template:** add {projectdir} template variable ([#350](https://github.com/kosukekoreyuki/prompt-line-plus/issues/350)) ([75cbc5e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/75cbc5e4a2165d52d9b742d7b21a0658517cf569))
* **tooltip:** add tooltip support to customSearch with Markdown link rendering ([#352](https://github.com/kosukekoreyuki/prompt-line-plus/issues/352)) ([9b101ee](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9b101ee55f1e366ad6533d95797752e188af3a1b))
* **tray:** show git hash and branch name in version display ([#287](https://github.com/kosukekoreyuki/prompt-line-plus/issues/287)) ([599a042](https://github.com/kosukekoreyuki/prompt-line-plus/commit/599a0427f5b0684a055111d4d6f61db9014a83b2))
* **ui:** add glassmorphic transparent window ([4a91a1d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4a91a1d6b29d0fb9d39a76d24d73382168250043))
* **ui:** add icon support for slash commands and agents ([776f096](https://github.com/kosukekoreyuki/prompt-line-plus/commit/776f096cd1bb9381989e676e43d694530520fe77))
* **window:** keep window open on blur, close only via Esc ([42c4f4b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/42c4f4b67653085265085e68156758bca79046f1))


### Bug Fixes

* **agent-built-in:** enable label search and hide agents on bare [@mention](https://github.com/mention) ([#353](https://github.com/kosukekoreyuki/prompt-line-plus/issues/353)) ([f6e3fd0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f6e3fd0b9061c570a0102e712184da2854079283))
* **agent-skill-manager:** add IME composition check for Japanese input support ([e048506](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e0485066913c140d7e377bb30b376385b7e51f0a))
* **agent-skill-manager:** fall back to first keyword when AND search returns no results ([f4c282e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f4c282e4a59103c336f5324191224f6dc92202f1))
* **agent-skill-manager:** handle query with trailing space in editing mode ([7758e84](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7758e841b4ade38cd3007467518b5aae2d829818))
* **agent-skill:** fix tooltip stuck on first item during navigation ([8c2fd1d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8c2fd1db55b845c50614f3d858263767e7cc4226))
* **agent-skill:** hide hint when cursor moves away from command highlight ([#276](https://github.com/kosukekoreyuki/prompt-line-plus/issues/276)) ([c36689f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c36689f72372dfcfd71b86c6971386ed6172c669))
* **agent-skill:** prevent in-place mutation of cached entries array ([d9ad7a8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d9ad7a8631ac56cc9077a68e2407e6075ff184ec))
* **agent-skill:** set editing mode before inserting text to prevent suggestion re-trigger ([7439a17](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7439a17a27a6269ef13d691649cbfc6b60d5682b))
* **agent-skills:** use terminal for commands and edit-sparkle for skills ([3fc229d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3fc229d5fe0978e3fb99388005358992e72a1265))
* **agent-skill:** track selected element reference during rendering ([a1d9cde](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a1d9cdea4921d7c75ac6fdf2443dde272326fbef))
* **build:** improve build speed and add install-app command ([#283](https://github.com/kosukekoreyuki/prompt-line-plus/issues/283)) ([14a4666](https://github.com/kosukekoreyuki/prompt-line-plus/commit/14a4666d15314359fc2137872724f936281e0a8c))
* **build:** preserve accessibility permissions across rebuilds with self-signed certificate ([#278](https://github.com/kosukekoreyuki/prompt-line-plus/issues/278)) ([6402ce7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6402ce774b58a5cfcde2880dd341435e477eac9e))
* **built-in-commands:** restore builtInCommands setting support after plugin migration ([#300](https://github.com/kosukekoreyuki/prompt-line-plus/issues/300)) ([c0151ad](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c0151ad62f69dc10e2702c3ad2609711753ebbf3))
* **changelog:** correct version order and add header for release-please ([8398415](https://github.com/kosukekoreyuki/prompt-line-plus/commit/83984152b0b5a5c855b7e5d3178660ec4dc8dab7))
* **changelog:** correct version order to put latest version first ([fbcd82f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fbcd82fa2bace2fb2661bec90b67f93a1c2c47cb))
* **ci:** sync pnpm-lock.yaml specifier with package.json for jsdom ([481f8e4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/481f8e490c5466b091f4838745d1c19e384d8406))
* **color-resolution:** strip quotes from color values before processing ([7e87e9b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7e87e9b158c79678e55dc492225beb0040e6ba90))
* **config:** update default settings for team and inbox patterns ([13c68d2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/13c68d2e70f38395371f21b87d0ca7e02296b624))
* **config:** update default task template description to use dirname ([4912514](https://github.com/kosukekoreyuki/prompt-line-plus/commit/49125140dc7c637dd311ee6ec3581c37e64443bd))
* **custom-search-loader:** implement keyword-based AND search for better query matching ([2fe2ab0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2fe2ab00e54042909f414db79779bd057a1c1bb6))
* **custom-search-loader:** scope deduplication per source entry instead of type ([c8b76d7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c8b76d7898eef9eb6a77f91d60e0cbe8cf024ca4))
* **custom-search:** insert trigger text at cursor position instead of replacing all text ([c04f6a1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c04f6a1193750534ae9817b80a890f970a9a88a9))
* **custom-search:** resolve {latest} by semver and prefer newer version on duplicates ([#381](https://github.com/kosukekoreyuki/prompt-line-plus/issues/381)) ([4600d77](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4600d77994ee2d227287e1609396d819c08015c2))
* **deps-dev:** bump tar from 7.5.7 to 7.5.9 in the npm_and_yarn group across 1 directory ([709ff6d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/709ff6dc6aef3f4768ba61945234a69287d225b4))
* **deps:** bump the npm_and_yarn group across 1 directory with 2 updates ([8e42efb](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8e42efbc1c70fa54a76ffedaca84ee3648c0b9a5))
* **deps:** resolve minimatch ReDoS and ajv ReDoS vulnerabilities ([8ba6dba](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8ba6dba06c1d60e9a0ca8bfb0410913b1134b854))
* **deps:** upgrade minimatch and ajv to fix ReDoS vulnerabilities ([cc7160c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cc7160c7571460dfa51d088b67e9ba8bb44b8d84))
* **deps:** upgrade minimatch and ajv to fix ReDoS vulnerabilities ([3b19baa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3b19baafee21e33b327045e04b1eaf4cc0707cfd))
* **directory-detector:** add storage fallback for Electron IDE directory detection without terminal ([5416c8a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5416c8a3e0536e778c6a9ad3efedbc29068b079c))
* **directory-detector:** add storage fallback for Electron IDE directory detection without terminal ([478ef35](https://github.com/kosukekoreyuki/prompt-line-plus/commit/478ef35e9d4d8b74d3c9ad256102f1ec18fec44a))
* **directory-detector:** detect JetBrains project directory without terminal tab ([6868bde](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6868bded8d4ddc9c6ea194a903cb137d420455a6))
* **directory-detector:** detect JetBrains project directory without terminal tab ([443c40f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/443c40f2bd646e121137a2b8a0aeff4813d584a1))
* **directory-detector:** fix pipe deadlock and add sqlite3 timeout ([44ed5f5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/44ed5f5165c4bf8834bc4e32eef58a5bfccf0b83))
* **directory-detector:** prioritize window title + state.vscdb for Electron IDE detection ([e11d3aa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e11d3aa2d143dcaaddf101bd60329e7c51a0ce74))
* **directory-detector:** resolve CWD to project root for Electron IDEs ([f6afa1a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f6afa1a2a77adf84897f6f2b42f8ce39eb6d7a4b))
* **directory-detector:** resolve shell CWD to project root for IDE terminals ([036521a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/036521aaff6617061450ba4a336d43c6e73505ed))
* **directory-detector:** resolve shell CWD to project root for JetBrains IDEs ([9582a67](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9582a67949e5db29e529a26b3aaffc9d09ffb986))
* **directory:** correctly detect CWD on Ghostty pane switch ([#375](https://github.com/kosukekoreyuki/prompt-line-plus/issues/375)) ([5b5c995](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5b5c995534285d222c6aab732ad763103d3c943b))
* **displayTime:** preserve sort order in agent dedup to show correct timestamps ([#358](https://github.com/kosukekoreyuki/prompt-line-plus/issues/358)) ([65ad3be](https://github.com/kosukekoreyuki/prompt-line-plus/commit/65ad3be9a2088b2e9752cac8c8e27a493b3f5a5d))
* **file-opener:** detect project root and pass to editor on open ([#298](https://github.com/kosukekoreyuki/prompt-line-plus/issues/298)) ([dcc95d3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/dcc95d385d45a36e22eff6b8905ebf9b1d9fd5c5))
* **file-opener:** match directory path itself in glob pattern matching ([7a09127](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7a09127467e5c1736d0ba92e656277af4e0a7e9c))
* **file-opener:** skip project root for non-editor apps ([#304](https://github.com/kosukekoreyuki/prompt-line-plus/issues/304)) ([5d0611f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5d0611f53f6f1b5b5f6b12729f60862699138197))
* **file-search:** allow /tmp access on macOS while maintaining security ([8d6db98](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8d6db98ab27daadfb30197835d4626c73401d850))
* **file-search:** enhance security and validation for includePatterns ([6375712](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6375712c53ca10f9efae24dccf6552963b0f406a))
* **file-search:** handle absolute paths in glob pattern extraction ([27db94f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/27db94f1b67375b1374c015ea6ea641e49a48757))
* **file-search:** skip non-existent directories in includePattern search paths ([89e282e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/89e282e649382e3fa659c2eb932c36d66370955b))
* **fileSearch:** pass maxFiles from settings to DirectoryInfo response ([aa93b3a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/aa93b3a28dcaa79ec0772af295b217a7f9bbc9f3))
* **history-search:** fix highlight not updating when search term changes ([4a1cfa5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4a1cfa5e7c95856448e6d8e0719bedf5c8a01e8e))
* **input:** add line break to textarea placeholder ([87bbbc5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/87bbbc55186d750c6581d4cc80da2b85ecee28c6))
* **input:** reduce text input placeholder opacity to 25% ([1607c4d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1607c4dd78a6fe2c60ccb2991d3de5029b0795fc))
* **install:** auto-restart app after install-app command ([#325](https://github.com/kosukekoreyuki/prompt-line-plus/issues/325)) ([561c809](https://github.com/kosukekoreyuki/prompt-line-plus/commit/561c8090d144b9b96b92a312164abebcc5077964))
* **jq-resolver:** add error handling and debug logging for WASM initialization ([fdd5787](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fdd5787f5e28f4f19cb94b4eedf99368d2828c0f))
* **jq:** use raw() to avoid TypeError when select() filters out data ([#296](https://github.com/kosukekoreyuki/prompt-line-plus/issues/296)) ([0631076](https://github.com/kosukekoreyuki/prompt-line-plus/commit/06310766d81b20c78510c9fea66c66a045437962))
* **layout:** override Tailwind v4 built-in .container max-width ([#259](https://github.com/kosukekoreyuki/prompt-line-plus/issues/259)) ([b8b36b6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b8b36b6d9614b7ad0b2cc88208ef97974f0e93bf))
* **mention:** prevent Tab focus escape when empty state popup is shown ([ad7344c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ad7344c5b94e369aa48c2f68bb51626bb810405a))
* **mentions:** correct rangesOverlap to detect full containment and add cache invalidation ([f1e5676](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f1e5676cc6de9e769bccd27f7772d5be80492502))
* **mentions:** hardcode label badge color to grey ([356bdce](https://github.com/kosukekoreyuki/prompt-line-plus/commit/356bdce7a3374d8e2a07b69c1587a32c471764e6))
* **mentions:** hide suggestions when no search results found ([978b73d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/978b73dee4b63c22c715b659293a702eb74914ab))
* **mentions:** improve mention dismissal with space input and show empty state ([fbd6e95](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fbd6e9561e409fa93c5d811d681f6016b3c04726))
* **mentions:** improve mention dismissal with space input and show empty state ([f8e848c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f8e848c1e70c9c6f91e45c597b9874f2830296d7))
* **mentions:** prevent re-showing suggestions after file path insertion ([5c7ed83](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5c7ed839d79e2e21b87f8475b739037c652510d1))
* **mentions:** prevent re-showing suggestions after symbol selection ([0321840](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0321840d9f59930624c73c48b6cc39a236da5989))
* **mentions:** prevent Tab from moving focus when empty state is shown ([09adb57](https://github.com/kosukekoreyuki/prompt-line-plus/commit/09adb572e85a0abdb84decf74efaaa826a1d9b3f))
* **mentions:** resolve Japanese file search issues (Unicode NFC/NFD, IME composition) ([3e57cc4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3e57cc451a90144c8519deae3543c377d2402bd4))
* **mentions:** resolve Japanese file search issues (Unicode NFC/NFD, IME composition) ([c54b105](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c54b10502b26061b74eb5cc1f804f25080082a2e))
* **mentions:** suppress Building Index and hint for non-capable apps ([4b3bac4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4b3bac4b6fbe51243255cc851dd611471bd46d9c))
* **mentions:** suppress Building Index and hint messages for non-capable apps ([059d6bc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/059d6bc02cc52327be1c9047de82b8ce8f647381))
* **mentions:** update agent color palette for better contrast and clarity ([9a07fa6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9a07fa6bc1ff08293627f535c08e38e1213afafa))
* **paste:** preserve image-path prompts when pasting into Claude Code on cmux/Ghostty/WezTerm ([#378](https://github.com/kosukekoreyuki/prompt-line-plus/issues/378)) ([76b8725](https://github.com/kosukekoreyuki/prompt-line-plus/commit/76b87251420fbca9cfe65564e9db2b35516e096c))
* **paste:** route cmux paste through AppleScript instead of Cmd+V ([#372](https://github.com/kosukekoreyuki/prompt-line-plus/issues/372)) ([b37d278](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b37d27819963f954e786cf78f28089268be257a6))
* **perf:** address code review findings for suggestion optimization ([0edebc1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0edebc18fa78e76d6151cee44920cfa225ddc8b1))
* **plugin:** align entryMap key with sourceId for sourceDir-based entries ([#343](https://github.com/kosukekoreyuki/prompt-line-plus/issues/343)) ([c2bf9cc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c2bf9cc41b4ce08c37b8f40fe63e4de1c2e432c8))
* **plugin:** auto-discover local YAML plugins without settings.yaml entries ([#337](https://github.com/kosukekoreyuki/prompt-line-plus/issues/337)) ([3a91831](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3a91831030e3d8aa267b7efc54ac5674b1b2545f))
* **plugin:** copy resource files alongside YAML during plugin install ([#345](https://github.com/kosukekoreyuki/prompt-line-plus/issues/345)) ([0edf54b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0edf54ba187acf3a2e49fed04ae63d8b33137886))
* **plugin:** hot reload for glob-pattern source file deletions ([#339](https://github.com/kosukekoreyuki/prompt-line-plus/issues/339)) ([8f3ee3f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8f3ee3fe098a64b18fef2431c098ebbe5222fce8))
* **plugins:** copy excludeMarker field in plugin search entry parsing ([#289](https://github.com/kosukekoreyuki/prompt-line-plus/issues/289)) ([3549844](https://github.com/kosukekoreyuki/prompt-line-plus/commit/35498441641aac39d05293144196519ca7bb0ff4))
* **plugins:** copy excludeMarker field in plugin search entry parsing ([#291](https://github.com/kosukekoreyuki/prompt-line-plus/issues/291)) ([bc16cee](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bc16cee1108ed13c2a674a2a62cd8d420ac48ca5))
* **plugins:** improve plugin install reliability and hot reload ([#306](https://github.com/kosukekoreyuki/prompt-line-plus/issues/306)) ([df455ae](https://github.com/kosukekoreyuki/prompt-line-plus/commit/df455aeecd818973c773248331ed6bdaa1fdabe9))
* **plugins:** increase comment truncation limit to 100 chars ([ba9d85e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ba9d85ee9162754e6fc9aa16a9c418f1698d7b9b))
* **plugins:** truncate long comments in plugin install output ([028d173](https://github.com/kosukekoreyuki/prompt-line-plus/commit/028d173359f6cfd4f31b46849f45f1012e5a2e17))
* **plugins:** use node wrapper for bin entry to resolve ts-node ([9530646](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9530646b4ea2b04672d19565ac628b924db7394f))
* **pnpm:** correct packageManager SHA hash for pnpm@10.30.0 ([4e0d92a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4e0d92ac87ba42dbd5be8f5b5959aedc3f54aa23))
* **projectdir:** invalidate {projectdir} command cache on directory change ([#357](https://github.com/kosukekoreyuki/prompt-line-plus/issues/357)) ([525f91c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/525f91cb5140170f7996f7332597e4f643681f4b))
* reset jqInitPromise on WASM failure and allow file-search IPC channel ([fb0961b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fb0961bfb582f29a9c6406a84c38f595a23f8d1f))
* restore package.json version to 0.25.3 ([204e767](https://github.com/kosukekoreyuki/prompt-line-plus/commit/204e767afc4d3ebcbec7df8c11cf3032d4ac998b))
* **search:** honor followSymlinks, core.excludesfile, and settings-aware cache invalidation ([#367](https://github.com/kosukekoreyuki/prompt-line-plus/issues/367)) ([874418f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/874418ffb038e4695b2c6bb722a9a8cdc42e5c75))
* **security:** escape user content in innerHTML and RegExp constructor ([cd98224](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cd9822424b06751d7c7566d3e2abe04b02f6208f))
* **security:** prevent shell injection in custom search command execution ([2c876d3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2c876d35f766e6684eb6f4c0e8af09289c4c57cb))
* **security:** remove double-quoting in command template and expand whitelist ([840cdc4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/840cdc45ea8584d01edabfde900bf530839c4a41))
* **security:** replace deepShellQuote with valueTransform to prevent CWE-78 bypass via JSON keys ([876eba5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/876eba5258178049511678b833386683240caa5e))
* **security:** replace execSync with execFileSync to prevent command injection ([068ae8b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/068ae8b00a639033d5d372ad9ee5c21567316ed3))
* **security:** shell-quote jsonData in buildShellSafeContext to prevent CWE-78 ([48cc668](https://github.com/kosukekoreyuki/prompt-line-plus/commit/48cc668a7c7473a5ae270597534830f4a89e6f30))
* **security:** upgrade yauzl to 3.2.1 (CVE-2026-31988) ([51e9ea5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/51e9ea59cae91c137fb179a20a37ac7132986d5f))
* **security:** upgrade yauzl to 3.2.1 via pnpm override (CVE-2026-31988) ([6347528](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6347528c89e87207b82bd75b1cc8ecdcbc061417))
* **security:** upgrade yauzl to 3.2.1 via pnpm override (CVE-2026-31988) ([c14d8dc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c14d8dca8d81745eef043af57a7ce7515b807184))
* **settings:** make shortcut overrides work and add toggle support ([2056534](https://github.com/kosukekoreyuki/prompt-line-plus/commit/20565348cd9b08cce5db88a2cc1e7edddab7d459))
* **settings:** reformat backup filename and add delay before opening directory ([175b671](https://github.com/kosukekoreyuki/prompt-line-plus/commit/175b671c1146bf55311f645bc63874426006fe0b))
* **slash-commands:** apply color attribute to command badge elements ([5ffbc43](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5ffbc4388d397a4e1aa7631d71b839028d4b497e))
* **styles:** correct color variable mappings to match Tailwind CSS conventions ([c67f4db](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c67f4db7d81b4927766464a629d4d50e74cc3ef7))
* **styles:** update codicon font size in agent suggestions from 14px to 16px ([ea7e69e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ea7e69e320245bfa4832def5744414f3bc66bd21))
* **symbol-search:** set rg cwd so includePatterns match ([#368](https://github.com/kosukekoreyuki/prompt-line-plus/issues/368)) ([3812cd9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3812cd9d50f2c5119370a1ef9ef857b34fe5d6a0))
* **test:** relax flaky scalability test threshold for CI environments ([f2b9dca](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f2b9dca5d04931155423839af51b53c0d2245fea))
* **tests:** update settings-manager test expectations to match current defaults ([4cab29f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4cab29ffe3565e0a76aa042642bf2eee28bcbdbc))


### Performance Improvements

* **cache:** conditional invalidation and prefetch for input completion ([#297](https://github.com/kosukekoreyuki/prompt-line-plus/issues/297)) ([e024d49](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e024d496e6a1289cd8a3a3c267e46b21199f8b30))
* **custom-search:** optimize JSONL search with hot reload, dedup fix, and caching ([#246](https://github.com/kosukekoreyuki/prompt-line-plus/issues/246)) ([ba1fbc1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ba1fbc1d071f1a94079c68ee43d42873bd2c21a2))
* **custom-search:** optimize JSONL search with hot reload, dedup fix, and caching ([#247](https://github.com/kosukekoreyuki/prompt-line-plus/issues/247)) ([592e204](https://github.com/kosukekoreyuki/prompt-line-plus/commit/592e204b71da567db249b755096860da3758ebc4))
* **custom-search:** replace TTL cache with event-driven invalidation and parallelize loading ([99e854e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/99e854e71660d1b585e8b8de996d070f2e152f5e))
* **custom-search:** replace TTL cache with event-driven invalidation and parallelize loading ([26019c2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/26019c25c8b463eef3531ba95dca69f97600d557))
* **history-search:** optimize E2E rendering pipeline for faster input ([63660e4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/63660e4f40087e7ce988ffb268ab07404d7d5919))
* **history-search:** optimize filter engine with caching and inlined scoring ([8345db2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8345db21a8f375b889b7fd8a6d9e845f1075424d))
* **history-search:** replace innerHTML with direct DOM building for search highlights ([d7e51b4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d7e51b4acea32b670d800e8e85dcbaf5b034d094))
* **history:** optimize rendering with DOM recycling and caching ([61980a6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/61980a6a6545cf0fd23e0e653513f1767409f85c))
* **history:** optimize search and input performance (Phase 1-5) ([42cf475](https://github.com/kosukekoreyuki/prompt-line-plus/commit/42cf47598754513823b7edc6b04c55094e496e7c))
* **history:** optimize search rendering and add custom search enhancements ([14423cc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/14423cc4f32f3b38365a4309b971fe278b88b531))
* **infinite-scroll:** optimize loadMore with result caching and incremental DOM ([6e84522](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6e84522be19bb084f3e3d2de461b8d80337c36e6))
* **install:** optimize install-app build time and improve codesign UX ([#327](https://github.com/kosukekoreyuki/prompt-line-plus/issues/327)) ([22b4f47](https://github.com/kosukekoreyuki/prompt-line-plus/commit/22b4f47b9b0c702425427bb9fa6582a742935aaf))
* **plugins:** lazy-load plugin-install module in CLI dispatcher ([65eae86](https://github.com/kosukekoreyuki/prompt-line-plus/commit/65eae86ae12ebfbd11dba77b888e94fceff45fbd))
* **renderer:** optimize text input event handlers with early returns and pre-sorted skills ([b4366c5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b4366c57a7733ae2d147a79be947f5bdba390e29))
* **search:** optimize keyword splitting and highlight matching ([ffc6784](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ffc6784db8452ddbd575650e319df46dc6db45eb))
* **suggest:** fix root causes of suggestion slowdown ([bed916d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bed916dfcbc52e4bbe2bfd95e755369435d06ee8))
* **suggestions:** fix @ mention and / command suggestion speed regression ([1ee59e2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1ee59e2aed8d689e7c5a9191d61e4ef61d7d1472))
* **suggestions:** optimize @ mention and slash command performance ([35abfd8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/35abfd87482f94bbd1e591b262938ef9792b9a91))
* **suggestions:** optimize renderer-side processing and eliminate redundant computations ([0cc6389](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0cc6389e5a2e5a7c4b5a5438ac53dff7b76c0b00))
* **suggest:** optimize @ mention and / command suggestion performance ([6901a58](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6901a585799a9b9c23a2eb636541261e2507033c))
* **template-resolver:** cache JSON.stringify for object terminals ([#364](https://github.com/kosukekoreyuki/prompt-line-plus/issues/364)) ([4571eba](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4571ebadd89c69f837b14415840e460357f9db12))
* **template-resolver:** precompile templates and cache JSON path tokens ([#362](https://github.com/kosukekoreyuki/prompt-line-plus/issues/362)) ([301ca2f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/301ca2f209814f9b28a268ac4bd697953b52c1da))


### Reverts

* restore separate path and pattern fields in customSearch ([cf9ef48](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cf9ef48800cb1ae564f20699cbe9829036e018e0))


### Documentation

* add fork credits and attribution (EN/JP) ([6c47398](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6c4739856b8186b3cc50cb9996a2fca71456bb43))
* add merge strategy guidelines to prevent CHANGELOG duplication ([b01b476](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b01b476130e591a26428b88a1555d4447c11b05c))
* **agent-skills:** remove vscode-codicons URL from icon comment ([40489c7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/40489c72dc4a8ef54a7d221e0990ac1ac8eebe36))
* align README overview structure with README_ja ([b36a8c3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b36a8c32e55582d2223915795035f76e402546e6))
* **built-in-commands:** update Claude, Codex, and Gemini slash commands to latest ([9fc771e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9fc771e3ecbd1919dce25714d4e67ae969647f0f))
* **built-in-commands:** update Claude, Codex, and Gemini slash commands to latest ([b514b6a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b514b6a9efe26b08f2517dbf4628b90800a268d4))
* **claude-md:** Fix inconsistencies between documentation and implementation ([e671e21](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e671e2185b0698f5d8a87eea8a8dc4656ee6130b))
* **config:** document dirname variables for slash commands and mentions ([8b38a04](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8b38a0461fe296215d7931081fc8adf96edd85f8))
* **custom-search:** add jq expression documentation and debug logging ([a98ec26](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a98ec26dfc75cd6ac7895b571127e88e84aea114))
* emphasize prompt input UX as core purpose in README_ja ([881b56f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/881b56f48d71fb2f26ac888542b5f07beb3eabf9))
* **mentions:** document new customSearch template variables and plain text file support ([fe03bbe](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fe03bbeb6b7eca1a335f74ac48d02d6da7151c78))
* **mentions:** reorder configuration table to list customSearch first ([403cd5b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/403cd5bca02b12af1bb2da454bc1a380b5163b16))
* move fd and ripgrep to system requirements section ([451c35b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/451c35b4fce9ed050a0358f116bd58311538914a))
* **native:** add testing workflow and Electron IDE detection strategy to CLAUDE.md ([354aae2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/354aae2b4242acec316f156d2d169652bcb29e1a))
* **plugins:** update help message for local repo support ([b17d6b0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b17d6b04da8870ff835c71de991a9cdcc23639ec))
* **README_ja:** expand documentation on input features and setup prerequisites ([27178cd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/27178cdb3214ebb79a550c94bd881d93eedc5dc2))
* **README_ja:** improve installation steps and update descriptions for dependencies ([c2ecbaa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c2ecbaaba9925a2ae02eb58e8917c15d7e02379a))
* **readme-ja:** add advanced search and autocomplete section ([7520b6d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7520b6d1e07f33b7c155c3ff3be8f5388c32f195))
* **readme-ja:** remove detailed sections on file operations and mentions ([3647a35](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3647a35bec5c5429f94cd6bebdd83d3e8e6d7d07))
* **readme-ja:** remove input autocomplete and detailed configuration sections ([2013e7d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2013e7d79d3eb6f67917ba7e3862a44eca80e8b9))
* **readme-ja:** simplify file and code search documentation ([8742f35](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8742f352ba3138a10d769629a8e80e363fe69185))
* **readme-ja:** update search and autocomplete section ([54de928](https://github.com/kosukekoreyuki/prompt-line-plus/commit/54de928570fc17153793c13aded3b0353b870319))
* **readme:** add step to update built-in commands in upgrade instructions ([072dcff](https://github.com/kosukekoreyuki/prompt-line-plus/commit/072dcffe58e0e975b0cf3d41d35d91d02ac15ebc))
* **readme:** clarify CJK character input support scope ([a023f4f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a023f4fd18e9373ec3dd2a246012e74df30a0bf8))
* **readme:** clarify context search and autocomplete features ([8782b62](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8782b62d4aa93ed44eaa4b9eae20ec2e4624f322))
* **readme:** clarify search and autocomplete feature labels and descriptions ([e2f6645](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e2f6645c9263733f8cbb30b567cb55e21d5f3dd7))
* **readme:** expand supported languages from Japanese to CJK characters ([042edfd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/042edfdffc9f0db3bc888ed6e372761474e58cd4))
* **readme:** refine search type labels and improve Japanese translation ([0c6f42b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0c6f42b9ab76355692bd495f76051f20b4d3a80e))
* **readme:** reorganize documentation with advanced search section ([d4511a1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d4511a1de220aeaf68aceccd9a1e3e613f61f1ab))
* **readme:** reorganize installation sections with prerequisite note ([c63ffe7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c63ffe77e94bbeae80225a0e8209fef98bf6ab8f))
* refine README_ja for clarity and improved feature explanation ([7537baf](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7537bafda1552dd1cd001d0a350b91c43714ab18))
* remove reset-accessibility step from update instructions ([#280](https://github.com/kosukekoreyuki/prompt-line-plus/issues/280)) ([6187373](https://github.com/kosukekoreyuki/prompt-line-plus/commit/61873735af12afce5af0a2388962be48c422d53d))
* rename Markdown Search to Custom Search and clarify supported formats ([a79adef](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a79adef37eb97720ca6536584b24739cd7e475f0))
* reorder CLI tools in README_ja (Codex before Gemini) ([df37341](https://github.com/kosukekoreyuki/prompt-line-plus/commit/df37341f538a3d58bbed20cd9daf73b01767fdb8))
* rewrite README in an original voice (EN/JP) ([0a7003c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0a7003c8d19f860489dded437684320e7b8a5a11))
* **scripts:** add documentation for mutation tests and build scripts ([74ec9c9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/74ec9c99cfb328008e9e445badc89d2d40f690dc))
* **search:** document AND search functionality across command and mention features ([7ffd9b9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7ffd9b9f8c0d9245fd93725f9e0fdeebb7a0442a))
* **settings:** add ghq repository comment to custom search example ([3a23bd5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3a23bd5ce7cc9f7d8cea9851ae6c469c43a3f342))
* **settings:** improve built-in commands documentation ([2c760fc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2c760fc816eb1359f6c5a348b25ad2cb52d4c0fe))
* **settings:** update example settings for plugin and mention configurations ([8326f33](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8326f33c87783c4f498c545345a9e243695b76dc))
* **settings:** update inputFormat comments and regenerate settings.example.yml ([37e9146](https://github.com/kosukekoreyuki/prompt-line-plus/commit/37e9146abc00451f947f34475a2cc56778e7e2c5))
* simplify root CLAUDE.md (590→159 lines) and fix renderer mention system structure ([4cc0aff](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4cc0aff444fd8f9bd8f8c0e26d532d9e3f5f3ad0))
* simplify root CLAUDE.md by removing redundant details covered in subdirectory files ([b3ab51a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b3ab51aebcac5351988b099f83d9831e665f89f6))
* simplify subdirectory CLAUDE.md files and add built-in commands guide ([3d3a74e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3d3a74e8b2d3e35290ee1e24efc6fedc9c612bde))
* **styles:** expand codicon-symbols.css with complete @vscode/codicons library ([6206371](https://github.com/kosukekoreyuki/prompt-line-plus/commit/620637140844f9041b9b89718b874e8b3d3880fa))
* **testing:** add guidance for suppressing console output in tests ([4e131cb](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4e131cb24cf8eeefa9878cfe12a8eac67e62d8b0))
* update architecture documentation with new handlers, managers, and utilities ([28e0406](https://github.com/kosukekoreyuki/prompt-line-plus/commit/28e04060f613b3674b6580f5684c0ffb9b452e88))
* update CHANGELOG.md with complete v0.29.4 release notes ([90c8c81](https://github.com/kosukekoreyuki/prompt-line-plus/commit/90c8c81eb99c2092cae592bbc27e9f43acc3e1ce))
* update Claude Code docs URL and built-in-commands guidelines ([78378c7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/78378c78b1474e729d1afd2bf7131bd4754f7799))
* update CLAUDE.md files for command execution and security boundary ([70b7cd5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/70b7cd5f11bef5960e346b89e10b3eecca81ca96))
* update CLAUDE.md files to reflect architectural refactoring ([a30d5e5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a30d5e51c2dbd293efd8d488a5422e6b749d47dc))
* update PR guidelines with develop branch merge strategy ([ec6e6aa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ec6e6aa81bd4d14ee25b3ff039379842c18e8272))
* update PR target branch rule to prefer develop branch ([5e9e97b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5e9e97bb56db48527fda14820a7e32c4f66d5bf2))
* update README overview to match README_ja changes ([8e5bf5a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8e5bf5a6b7ec2f7df770e4f4f240012b9cd0ddff))
* update README_ja overview to focus on prompt input UX ([d3cf22e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d3cf22eb5b0ff2c9e8333a1ec18449e25d899044))


### Styles

* **colors:** convert colors from hex/rgba to oklch format ([1bbaeef](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1bbaeef70bd9c275bcdfb1c50f757a704def48be))
* **file-suggestions:** add codicon font sizing for agent suggestion items ([530fc0f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/530fc0fad3ae23e2098c597a412fca1ee5935205))
* **history-item:** increase border opacity for better visibility ([bb84b37](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bb84b376e3faaf85b0ebe1ec658d751022ed1fd5))
* improve visual hierarchy in file suggestions and history ([3fd27ac](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3fd27ac9e672a232115da464cc31003ea396afaa))


### Miscellaneous Chores

* **built-in-commands:** add new Claude Code commands and update descriptions ([a3ab77f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a3ab77f032cbd4274e731a59aff45750a3e2a4de))
* **built-in-commands:** remove reset command and display path on update ([9383f59](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9383f59f8dae9135fd1802d6c89887e56b57308e))
* **built-in-commands:** remove reset command and display path on update ([fbe36c3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fbe36c3fc74860dd9d1d9284ad1f82af42e32a1b))
* **ci:** remove release-type from release-please workflow ([4b63d47](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4b63d477a4f855851a5cb6e4b53f10bad2be9a86))
* **ci:** remove unnecessary `permissions` block from workflow configuration ([ba4ebf0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ba4ebf055c0768b0bb9cc30adb18ae9f44eacbfc))
* **config:** remove openclaw and opencode from example built-in commands ([a04e9b4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a04e9b4efb9ad7892eaa08cb0ca200bb073239f6))
* **config:** switch release-type to simple and unhide docs changelog section ([25277af](https://github.com/kosukekoreyuki/prompt-line-plus/commit/25277af5d69afa394415a3ed0c63f93d53c36d91))
* **config:** update release-type to node in release-please-config.json ([751e8af](https://github.com/kosukekoreyuki/prompt-line-plus/commit/751e8af10ea23524d5072d2df991c3c3cf5026f7))
* **deps-dev:** bump electron ([b429e7f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b429e7fb9ad28a20e6b68f6862aee9743d6ad7f2))
* **deps-dev:** bump electron from 36.9.5 to 39.8.4 in the npm_and_yarn group across 1 directory ([#316](https://github.com/kosukekoreyuki/prompt-line-plus/issues/316)) ([b4bf2a8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b4bf2a81fefd43381c4107ed5e1623689ac49be7))
* **deps-dev:** bump electron from 39.8.4 to 39.8.5 in the npm_and_yarn group across 1 directory ([390da53](https://github.com/kosukekoreyuki/prompt-line-plus/commit/390da5366396a54f676d87a4e29a4a2bf458a66f))
* **deps-dev:** bump tar in the npm_and_yarn group across 1 directory ([e2d117c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e2d117c0acaf8634b95a73efd84c917252ea6378))
* **deps-dev:** bump vite from 6.4.1 to 6.4.2 in the npm_and_yarn group across 1 directory ([#331](https://github.com/kosukekoreyuki/prompt-line-plus/issues/331)) ([d1256b3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d1256b33bbbeb3512e60c1d49f816a961e2dece5))
* **deps:** add @vscode/codicons dependency ([3e0fd01](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3e0fd01e416a06af662819ef0b13972c9113501b))
* **deps:** bump @xmldom/xmldom from 0.8.11 to 0.8.12 in the npm_and_yarn group across 1 directory ([#311](https://github.com/kosukekoreyuki/prompt-line-plus/issues/311)) ([69e35ab](https://github.com/kosukekoreyuki/prompt-line-plus/commit/69e35ab461bb656b7c8f318e4ca64a28863533e2))
* **deps:** bump @xmldom/xmldom from 0.8.12 to 0.8.13 in the npm_and_yarn group across 1 directory ([#365](https://github.com/kosukekoreyuki/prompt-line-plus/issues/365)) ([c0d6921](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c0d69219d250372b5b0944718706604185abbde2))
* **deps:** bump brace-expansion from 5.0.2 to 5.0.5 in the npm_and_yarn group across 1 directory ([#299](https://github.com/kosukekoreyuki/prompt-line-plus/issues/299)) ([348cd08](https://github.com/kosukekoreyuki/prompt-line-plus/commit/348cd08d339835a89d15c10f6bfa11ea59f41c8a))
* **deps:** bump fast-uri from 3.1.0 to 3.1.2 in the npm_and_yarn group across 1 directory ([#385](https://github.com/kosukekoreyuki/prompt-line-plus/issues/385)) ([069a232](https://github.com/kosukekoreyuki/prompt-line-plus/commit/069a232729cf11bd6406717086123ef7afad18f4))
* **deps:** bump flatted from 3.3.3 to 3.4.1 in the npm_and_yarn group across 1 directory ([#256](https://github.com/kosukekoreyuki/prompt-line-plus/issues/256)) ([b10398f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b10398ffecc9c91626c80a1efa7ff6a9e3d999e6))
* **deps:** bump flatted from 3.4.1 to 3.4.2 in the npm_and_yarn group across 1 directory ([fb66f0a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fb66f0ad74361e2c9aef3a06a828fef451a1b3a3))
* **deps:** bump flatted in the npm_and_yarn group across 1 directory ([d556b44](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d556b44d1cd7b9fd835c2ad7848b5a663a5d9a42))
* **deps:** bump ip-address from 10.1.0 to 10.2.0 in the npm_and_yarn group across 1 directory ([#383](https://github.com/kosukekoreyuki/prompt-line-plus/issues/383)) ([bbfaac0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bbfaac0c8e7f3f258d6898348daee273e6393f45))
* **deps:** bump lodash from 4.17.21 to 4.17.23 in the npm_and_yarn group across 1 directory ([#314](https://github.com/kosukekoreyuki/prompt-line-plus/issues/314)) ([508bf4a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/508bf4ae6db4cc36b02947d1f4a8b3e2f17fb095))
* **deps:** bump lodash from 4.17.23 to 4.18.1 in the npm_and_yarn group across 1 directory ([#318](https://github.com/kosukekoreyuki/prompt-line-plus/issues/318)) ([082695d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/082695d51b396aafe923ac6696db84625c63dc6d))
* **deps:** bump picomatch from 2.3.1 to 2.3.2 in the npm_and_yarn group across 1 directory ([#294](https://github.com/kosukekoreyuki/prompt-line-plus/issues/294)) ([63b0e07](https://github.com/kosukekoreyuki/prompt-line-plus/commit/63b0e0718aea480117476316303c31aa4ff88c2b))
* **deps:** bump postcss from 8.5.8 to 8.5.12 in the npm_and_yarn group across 1 directory ([#373](https://github.com/kosukekoreyuki/prompt-line-plus/issues/373)) ([3274f2e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3274f2e5accd81343e4b50a0e377fcefcf2dbb30))
* **deps:** bump qs from 6.14.1 to 6.14.2 in the npm_and_yarn group across 1 directory ([d623f9d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d623f9d80266f0777406f57acc3cf72288878f1b))
* **deps:** bump qs in the npm_and_yarn group across 1 directory ([983056f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/983056ff29c03931412a1e8d820d69899874f383))
* **deps:** bump tar from 7.5.10 to 7.5.11 in the npm_and_yarn group across 1 directory ([#244](https://github.com/kosukekoreyuki/prompt-line-plus/issues/244)) ([4bcb378](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4bcb378b762e5801ea6ca19e813d18003b4c0a0a))
* **deps:** bump tar from 7.5.9 to 7.5.10 in the npm_and_yarn group across 1 directory ([3a4bb92](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3a4bb92bdaa0ff092785730fd4c6de83d0b21337))
* **deps:** bump tar in the npm_and_yarn group across 1 directory ([0605d53](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0605d53b43786482e22c0e424e4f8ec01ac32b23))
* **deps:** bump the npm_and_yarn group across 1 directory with 2 updates ([256fb9b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/256fb9b1b266c8adbc4982806012c96af2e4b3ee))
* **deps:** bump the npm_and_yarn group across 1 directory with 2 updates ([d94cf2b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d94cf2ba7ef48c84d12d21851c759c774c837ee3))
* **deps:** bump the npm_and_yarn group across 1 directory with 2 updates ([d4d01c9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d4d01c94482141bf79a2ed0503e9a5cec2f2ecc4))
* **file-opener:** simplify directory example to my-go* ([3513db1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3513db1b39aad8023def63a3cf3703916fe6ca96))
* **main:** release 0.21.0 ([b64c460](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b64c460ed904fb4bb7e2b6c02b08693f2faa1a24))
* **main:** release 0.21.0 ([f906c49](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f906c499f15e124fa205cce2a5b9c40734f2b348))
* **main:** release 0.22.0 ([64614cd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/64614cd223e00ae6f70d30359cf250f63f962313))
* **main:** release 0.22.0 ([4571162](https://github.com/kosukekoreyuki/prompt-line-plus/commit/45711629a1a3224e826a8af61e9c2731f79c84a3))
* **main:** release 0.22.0 ([3873bea](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3873bea74328f944366d73c32977ad443d0cad8f))
* **main:** release prompt-line 0.23.0 ([c81eb99](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c81eb99ba1d830274b6ba4cb386f8440df600776))
* **main:** release prompt-line 0.23.0 ([9bb7f2e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9bb7f2ee1577afda3e5267b8dec382785eb2abbd))
* **main:** release prompt-line 0.23.1 ([f99aab4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f99aab42311458c1bfc687211f71c53c45ee9255))
* **main:** release prompt-line 0.23.1 ([22ff3c1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/22ff3c178b5a2e135ba86b02af82a64d3653ecdc))
* **main:** release prompt-line 0.24.0 ([a7838b8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a7838b8e4b026b3e48a005ae9f1311c28bcd398c))
* **main:** release prompt-line 0.24.0 ([b81c3ee](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b81c3ee1237702ce4c36c1e0444c8f11facbb83b))
* **main:** release prompt-line 0.24.1 ([de582df](https://github.com/kosukekoreyuki/prompt-line-plus/commit/de582df5b88b4fc6e1094a5adfbbf528bc2d3e97))
* **main:** release prompt-line 0.25.0 ([76d3d5c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/76d3d5c38b35c3ec265e09a50b9e986e08bf9f33))
* **main:** release prompt-line 0.25.0 ([1ab9ce2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1ab9ce2d81882f5bc07564746597b552b312277f))
* **main:** release prompt-line 0.25.1 ([70c2f08](https://github.com/kosukekoreyuki/prompt-line-plus/commit/70c2f081ce66897fb0c931fe1a55b711cd783922))
* **main:** release prompt-line 0.25.1 ([73ca577](https://github.com/kosukekoreyuki/prompt-line-plus/commit/73ca57779f258db36992e7cbb04ffee05d89f199))
* **main:** release prompt-line 0.25.2 ([0fe07f5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0fe07f58fe8cafc41791d4e426890e8f20c9d6ca))
* **main:** release prompt-line 0.25.2 ([25c3205](https://github.com/kosukekoreyuki/prompt-line-plus/commit/25c32050840b7f4e7bb01d98eebe671b193d0971))
* **main:** release prompt-line 0.25.2 ([0426e12](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0426e128d1278cc6868d10841f8548b48119faa0))
* **main:** release prompt-line 0.25.3 ([287dd88](https://github.com/kosukekoreyuki/prompt-line-plus/commit/287dd88ba7a3a44e7478572dbb7e1a972861e933))
* **main:** release prompt-line 0.25.3 ([ae30cec](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ae30ceca865c52a2d0d8bea04a219966b331f1d8))
* **main:** release prompt-line 0.26.0 ([1fb7cd1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1fb7cd165d2946ac5ec4b98d50e1ce0b21673177))
* **main:** release prompt-line 0.26.0 ([7e90689](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7e90689cf9bfaa36476296b38dd144840921fbbf))
* **main:** release prompt-line 0.26.1 ([#242](https://github.com/kosukekoreyuki/prompt-line-plus/issues/242)) ([2081397](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2081397cb2f18de23cc7b92302dc6e55c7eaafe0))
* **main:** release prompt-line 0.26.2 ([#245](https://github.com/kosukekoreyuki/prompt-line-plus/issues/245)) ([2adb209](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2adb209bd3d79df39ffbd2351700410acd292043))
* **main:** release prompt-line 0.26.3 ([#248](https://github.com/kosukekoreyuki/prompt-line-plus/issues/248)) ([3ab424b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3ab424b9624ed24d91ff0d75f5e0479a66aa63fe))
* **main:** release prompt-line 0.27.0 ([f298b83](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f298b8333ee5e210831c1c9bc6f75a319130286d))
* **main:** release prompt-line 0.27.0 ([#255](https://github.com/kosukekoreyuki/prompt-line-plus/issues/255)) ([3d36749](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3d367493267b63a55b7c32b044ab995a43351cc8))
* **main:** release prompt-line 0.27.1 ([016bdc3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/016bdc309cced23bf45e8ea2be5ad87f3c2164e1))
* **main:** release prompt-line 0.27.1 ([#257](https://github.com/kosukekoreyuki/prompt-line-plus/issues/257)) ([2f5c90b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2f5c90b5b000cbd13ef57499fd9d90c95ad1e141))
* **main:** release prompt-line 0.27.2 ([a7db1c7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a7db1c796f20d5c0cc3d8c783c3efb63b3d0bba9))
* **main:** release prompt-line 0.27.2 ([de32319](https://github.com/kosukekoreyuki/prompt-line-plus/commit/de323195c0856d1e08a58949218e136317a2a2eb))
* **main:** release prompt-line 0.28.0 ([b9c96e8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b9c96e8f9f7b1f542ae972c074bba373fe6a10db))
* **main:** release prompt-line 0.28.0 ([cf4174e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cf4174e41229fb8a0c8a200bb9508a88a12ea783))
* **main:** release prompt-line 0.28.0 ([b0dcbba](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b0dcbba09cfdeb851f29400876425a2ec9577ecc))
* **main:** release prompt-line 0.28.1 ([b0051d6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b0051d6d420e97a40286d9a44268938a549ef802))
* **main:** release prompt-line 0.28.1 ([93c0e4d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/93c0e4d320578459746efff0dfc5c8f8c8db447c))
* **main:** release prompt-line 0.28.1 ([dcfd3ea](https://github.com/kosukekoreyuki/prompt-line-plus/commit/dcfd3eaa2330e69a6f3d2c82b56c1d3d3169bf8d))
* **main:** release prompt-line 0.28.2 ([345defc](https://github.com/kosukekoreyuki/prompt-line-plus/commit/345defc97d4191a952d6e5e6986c058d0762bef4))
* **main:** release prompt-line 0.28.2 ([a276b81](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a276b81d267185f07fbad5bfd7945cd8b8a5b9b2))
* **main:** release prompt-line 0.28.3 ([b3e905b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b3e905b77c16c7b4b187f75df8914c11f2a8f3ca))
* **main:** release prompt-line 0.28.3 ([15d2d85](https://github.com/kosukekoreyuki/prompt-line-plus/commit/15d2d8597518319f1ca9ca93c319d122691688ce))
* **main:** release prompt-line 0.28.4 ([cb951b7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cb951b732c610defcc97b8704f0725a3c94a6bbe))
* **main:** release prompt-line 0.28.4 ([3f9b8cf](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3f9b8cfafa9fafd2ec8bb9644194a3b66a80570f))
* **main:** release prompt-line 0.28.5 ([#279](https://github.com/kosukekoreyuki/prompt-line-plus/issues/279)) ([ab619f1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ab619f1bdd3e6867aba09243650ed3a338e7c6d0))
* **main:** release prompt-line 0.28.6 ([#282](https://github.com/kosukekoreyuki/prompt-line-plus/issues/282)) ([505476f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/505476f0d07f10603debdbf25bd8763a960ac9cb))
* **main:** release prompt-line 0.28.7 ([#284](https://github.com/kosukekoreyuki/prompt-line-plus/issues/284)) ([2742e7e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2742e7e345e016264bc6ba732066a7c03126da1f))
* **main:** release prompt-line 0.28.8 ([9e7b1a8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9e7b1a8715f271a26b625aca985f6414efd6e366))
* **main:** release prompt-line 0.28.8 ([04e10f5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/04e10f5f821977be01a733dfe951875fd1a0ec06))
* **main:** release prompt-line 0.28.9 ([dbae2d6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/dbae2d642411f4d395655bef9f2a331367071442))
* **main:** release prompt-line 0.28.9 ([8935c46](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8935c46aa2f2bb4fe4ab1f5925800406efb3be98))
* **main:** release prompt-line 0.29.0 ([001e1f6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/001e1f69d5c8a72b962631ef90ad8266552be2b1))
* **main:** release prompt-line 0.29.0 ([b13f12f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b13f12f0798f6d73b03748f907ad79a53b508980))
* **main:** release prompt-line 0.29.1 ([1aebaa5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1aebaa5fc4391a130f6a4e9f74144f764624ed20))
* **main:** release prompt-line 0.29.1 ([3b83bfd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3b83bfd2a4e0055eb5b0de50bc72a1166223a5b5))
* **main:** release prompt-line 0.29.2 ([9bffcfe](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9bffcfe9159902f4c1ab1716e4c287a030ddc656))
* **main:** release prompt-line 0.29.2 ([da0f6ac](https://github.com/kosukekoreyuki/prompt-line-plus/commit/da0f6ac513f50ea70d8510d649937198677793bf))
* **main:** release prompt-line 0.29.3 ([#332](https://github.com/kosukekoreyuki/prompt-line-plus/issues/332)) ([03b9d95](https://github.com/kosukekoreyuki/prompt-line-plus/commit/03b9d95dbcb41a735a59219b62409ecb4cbee4d2))
* **main:** release prompt-line 0.30.0 ([50d80a9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/50d80a9501fa21dcfcb0bc607b5ba43bc02de002))
* **main:** release prompt-line 0.30.0 ([9c6b332](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9c6b3322cd2d813dff2b5c1423b5019d3a491bb8))
* **main:** release prompt-line 0.30.1 ([#338](https://github.com/kosukekoreyuki/prompt-line-plus/issues/338)) ([abc35be](https://github.com/kosukekoreyuki/prompt-line-plus/commit/abc35bef7147b57ce623539dc27719b59d0a9d80))
* **main:** release prompt-line 0.30.2 ([93d6754](https://github.com/kosukekoreyuki/prompt-line-plus/commit/93d675488fa2ce45a2c37abd6feea0334caa2b18))
* **main:** release prompt-line 0.30.2 ([d1acd27](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d1acd2700740092113ab58471267c9aefe6f579d))
* **main:** release prompt-line 0.31.0 ([#342](https://github.com/kosukekoreyuki/prompt-line-plus/issues/342)) ([837cf44](https://github.com/kosukekoreyuki/prompt-line-plus/commit/837cf4450cb0e091d50e0c46ae39726ddf426a64))
* **main:** release prompt-line 0.31.1 ([#344](https://github.com/kosukekoreyuki/prompt-line-plus/issues/344)) ([bfdd842](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bfdd8429caf95c598d447c84f4dfa1640ef36be0))
* **main:** release prompt-line 0.31.2 ([#346](https://github.com/kosukekoreyuki/prompt-line-plus/issues/346)) ([ab367a5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ab367a53ab6b24eb1dd3c63016e75c0bb0cad228))
* **main:** release prompt-line 0.32.0 ([5ba75de](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5ba75dedb849e226ffac3fe2b944beec6d5f6ac9))
* **main:** release prompt-line 0.32.0 ([98a3443](https://github.com/kosukekoreyuki/prompt-line-plus/commit/98a3443ef670edcbf32aa92a2ddecbab5eaec6d3))
* **main:** release prompt-line 0.33.0 ([f1d92f8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f1d92f8509e5a52c911f4e19bec02a362d9033b9))
* **main:** release prompt-line 0.33.0 ([1e80490](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1e8049097e032d899a1d0cc45007e98a9d3e4550))
* **main:** release prompt-line 0.33.1 ([5111eb2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5111eb283006ee41ef0ce6c1c2bbc4fbb5f57aaf))
* **main:** release prompt-line 0.33.1 ([9f2804c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/9f2804c8b78177ebbe3968123fd754e8b6db5cd9))
* **main:** release prompt-line 0.34.0 ([84a5da9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/84a5da9b931c07a7faa2ee25ac7b621f2bff5301))
* **main:** release prompt-line 0.34.0 ([6f6367d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6f6367db56ba6a9ccef66fa4b7c7d06330108fc3))
* **main:** release prompt-line 0.34.1 ([#363](https://github.com/kosukekoreyuki/prompt-line-plus/issues/363)) ([2060b5a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2060b5aa98351dd319f643f7b78a0cf37a0d2b09))
* **main:** release prompt-line 0.34.2 ([#366](https://github.com/kosukekoreyuki/prompt-line-plus/issues/366)) ([7a3ad4a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/7a3ad4a8c206ecc3e48ee35dc10192c2b3e1f53e))
* **main:** release prompt-line 0.34.3 ([#369](https://github.com/kosukekoreyuki/prompt-line-plus/issues/369)) ([977f7e3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/977f7e3ce423842fa212bc3f4c34a74e8f652411))
* **main:** release prompt-line 0.35.0 ([#371](https://github.com/kosukekoreyuki/prompt-line-plus/issues/371)) ([af3ac55](https://github.com/kosukekoreyuki/prompt-line-plus/commit/af3ac556081f271af17d10dc65e71443708d1012))
* **main:** release prompt-line 0.35.1 ([#374](https://github.com/kosukekoreyuki/prompt-line-plus/issues/374)) ([86bd45e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/86bd45e893317459caffaf6a71f8e9d62413e274))
* **main:** release prompt-line 0.35.2 ([#376](https://github.com/kosukekoreyuki/prompt-line-plus/issues/376)) ([56c0b23](https://github.com/kosukekoreyuki/prompt-line-plus/commit/56c0b23ec69c5a2707bf1e13fe6948be9891ecf1))
* **main:** release prompt-line 0.36.0 ([#379](https://github.com/kosukekoreyuki/prompt-line-plus/issues/379)) ([44c8e6c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/44c8e6c8f386889d842969daf0c8f8a2d06fb3ef))
* **main:** release prompt-line 0.36.1 ([#382](https://github.com/kosukekoreyuki/prompt-line-plus/issues/382)) ([2c752c1](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2c752c1f4c9a3ca60f2c2d2d8816690bf8bc3e41))
* **main:** release prompt-line 0.36.2 ([#384](https://github.com/kosukekoreyuki/prompt-line-plus/issues/384)) ([b619e7d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b619e7d04145f0ad90e554187a04415b526f9ebf))
* **main:** release prompt-line 0.36.3 ([#386](https://github.com/kosukekoreyuki/prompt-line-plus/issues/386)) ([5f1eb66](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5f1eb66b92ce5ece1a006ea27b86f95feefde038))
* **mentions:** remove built-in task mention configuration ([8e2fefd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8e2fefd1a76d7c93c8f55b84d197d772414764c3))
* merge main into develop (resolve conflicts, remove .serena, sync deps) ([6be829c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6be829cfaeedb7e77ac9e639a388f686691ca6d0))
* merge main into develop (resolve conflicts, sync v0.29.2) ([6d4c703](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6d4c7035e995416bca828a6062fe6e4df97ebc8f))
* merge main into develop (sync v0.29.3, resolve release-please conflict) ([3a950c3](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3a950c3bf736b9515c344616f489a6907351eb93))
* migrate from Release Please to Changesets ([#315](https://github.com/kosukekoreyuki/prompt-line-plus/issues/315)) ([1ed5559](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1ed55595fb5fc55138c619bbae6ce075a2e1f830))
* **pnpm:** migrate from npm to pnpm package manager ([29d0e35](https://github.com/kosukekoreyuki/prompt-line-plus/commit/29d0e35068d6696b23b27922fb3fd86f258ad5a3))
* **pnpm:** migrate from npm to pnpm package manager ([fb9ab96](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fb9ab96dafb0dafc9f6f9e0c384c9bf485b1cbf1))
* **pnpm:** update pnpm from 10.30.0 to 10.30.1 ([1d1b775](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1d1b77542fd7252a59501c499e049e3e989d045a))
* rebrand to prompt-line-plus ([fe29d9f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fe29d9ff58a5022b4c8213d794354ba5b07a33d7))
* remove investigation report ([115c42f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/115c42f71bf8356a1f1531cd490b5ca810c4e5e2))
* remove Serena project-specific files and directories ([1c07d72](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1c07d7254834e494294ae2440e582f1e33a4c20c))
* remove unused Serena project configuration ([f7f47f7](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f7f47f7fc0d9fbb8a3e17bcfb8db34eec6ca7405))
* revert from Changesets to Release Please for release automation ([c0f3b45](https://github.com/kosukekoreyuki/prompt-line-plus/commit/c0f3b45eba51e71dfbbcf45d9373ffbcbc1f7a79))
* **serena:** add line_ending and read_only_memory_patterns config options ([5d204fd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/5d204fd3d3f83c990dba010b881cc4f55fcb527b))
* **settings:** remove obsolete built-in command examples ([a244472](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a244472e894504ac5698ed42aee112b296814a5e))
* **settings:** update plugin command and skill labels and colors ([0fcd2e4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0fcd2e40227928d5178ad04673e8a97304da58c7))
* update pnpm packageManager to 10.30.3 ([1dcbb4f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1dcbb4fbedabcca223961858f093102f43201371))
* update serena project.yml to latest template ([daf6672](https://github.com/kosukekoreyuki/prompt-line-plus/commit/daf667254718767c61354acc494ce5bc71ea6eac))


### Code Refactoring

* **agent-skill-manager:** simplify skill insertion to always use trailing space ([991c934](https://github.com/kosukekoreyuki/prompt-line-plus/commit/991c93492cdd08b424a18498199688f3044f10a7))
* **agent-skills:** simplify icon rendering and hoist regex constant ([bf645fb](https://github.com/kosukekoreyuki/prompt-line-plus/commit/bf645fb3c4bb731df4d38c978edfeaabf862b870))
* **built-in-commands:** rename built-in-commands to agent-built-in ([#302](https://github.com/kosukekoreyuki/prompt-line-plus/issues/302)) ([a194626](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a194626ca147b030f1d4384d7c17f233a35aa9f1))
* **config:** rename slash command function to agent skill ([ba2ad41](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ba2ad414c4995538e4fc3e5b771117553df9bf29))
* **config:** restructure agent skills configuration ([ae9f2a9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ae9f2a9705df82c60235b18f963edf0ae4a39300))
* **config:** standardize on .yaml extension with .yml fallback ([#309](https://github.com/kosukekoreyuki/prompt-line-plus/issues/309)) ([1ca2bf8](https://github.com/kosukekoreyuki/prompt-line-plus/commit/1ca2bf8d51449cf6b17ac70cf04e0075fe8afe33))
* **config:** update mdSearch template formatting for agent names ([3aff7c2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3aff7c2713d18d3e9af63b681570b6686cf97f30))
* **config:** update YAML generator comments for agentSkills and remove versioning from release-please config ([f68b887](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f68b887d5b03c4a065412b1719e823c0a2f4bdec))
* **custom-search:** consolidate path and pattern into unified glob path ([4a709e4](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4a709e408e61d7286fde9f868c9e26a253ef3b5c))
* **custom-search:** remove pattern field in favor of path-based glob detection ([93fc6c0](https://github.com/kosukekoreyuki/prompt-line-plus/commit/93fc6c01c569d1a4aaa215040c5db96820e11403))
* **custom-search:** rename sortOrder to orderBy with enhanced format support ([cbb67c6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cbb67c61285781f90d38a488d6cf1a8d4d8fb5df))
* **directory-detector:** extract shared hint matching helper to eliminate duplication ([6aa93de](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6aa93de266c2101522b29590d2f5b1310e146c02))
* extract helper functions to fix ESLint warnings and add symlink support ([8eecb1b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8eecb1bce79a8d04a8f381fe16226126cdf02873))
* extract splitKeywords to shared module and clean up dead code ([f1931e5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f1931e5a70f1745fe1b63fe6303c20bd52ead6a3))
* **input-format:** replace 'path' literal with {filepath} template ([b93ceac](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b93ceacd20a3d06467bb887e07383308e9e0ceff))
* **mentions:** apply symbol-type-badge class to agent labels ([96ce779](https://github.com/kosukekoreyuki/prompt-line-plus/commit/96ce77945703d64e1375a5d42a2648a6dfb7fa9a))
* **mentions:** consolidate render methods and optimize hot-path ([fa89294](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fa89294f83145bde01e8ccfb0d60b1bbc24faf32))
* **mentions:** extract shared helpers and fix overlap detection bug ([10d2d71](https://github.com/kosukekoreyuki/prompt-line-plus/commit/10d2d713a709361b0f9bca0bed36561f23142bf6))
* **mentions:** migrate symbolIcons to @vscode/codicons font-based approach ([4f0163b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4f0163bf33086654fc0b0521b906aae984d917ca))
* **mentions:** reorder description element after label badge ([cadc1aa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cadc1aa8f8f18af2ba2a866b72917f735a57f096))
* **mentions:** simplify after review findings ([e37ab7a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/e37ab7af50f6dc9f348a52289f498541682acd84))
* **mentions:** simplify inputFormat existence check for @ prefix insertion ([8ca7ebb](https://github.com/kosukekoreyuki/prompt-line-plus/commit/8ca7ebb2269753c36a36860a019367d34187e397))
* **migrate-settings:** replace auto-opening with manual command display ([0eaac2f](https://github.com/kosukekoreyuki/prompt-line-plus/commit/0eaac2f7fab2a35e0b88008a6403ea615e68b192))
* **plugins:** migrate built-in-commands to plugin system and reorganize directory structure ([#292](https://github.com/kosukekoreyuki/prompt-line-plus/issues/292)) ([6c2ead2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6c2ead277a42243f916b1473e024d03194f8b21a))
* remove debug logging statements ([2815bc6](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2815bc6589124632d90f83cf716479dd38351ace))
* rename mdSearch to customSearch for improved clarity ([5337872](https://github.com/kosukekoreyuki/prompt-line-plus/commit/53378726ce8acd23639fea57fc3a71f2049750c3))
* rename MdSearch to CustomSearch with JSON file support ([d8f6050](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d8f6050a7b51d8c1fe82e7e6d04a99f29b8196a6))
* rename slashCommand to agentSkill across codebase ([63b092d](https://github.com/kosukekoreyuki/prompt-line-plus/commit/63b092d35436d3196c33f277ccdd02cab2a610ae))
* **search:** extract inputFormat logic and optimize template resolution ([ff23168](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ff231683be70dc04966c0335e6adb61809c655be))
* **search:** rename md-search to custom-search ([884dd84](https://github.com/kosukekoreyuki/prompt-line-plus/commit/884dd8425832ca03391716b7f0e94112dce0041e))
* **settings:** refactor prefixPattern to values map and add configurable trigger characters ([4f259c9](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4f259c97d48ed302b883515e742ab656c147917b))
* **settings:** rename mentions to customSearch configuration ([fdf0dcf](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fdf0dcf67c2dd115d298dd9276db618838fcd772))
* **slash-command-manager:** only render icon when explicitly configured ([3d93328](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3d933288b140e5775a0a74ed61446a25d307886d))
* **styles:** convert colors to oklch format ([dce18fa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/dce18fad0d09c7c41c4a6685fcf61cd96c6e60aa))
* **styles:** migrate to Tailwind [@apply](https://github.com/apply) directives and consolidate CSS variables ([ee3aee5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ee3aee551fc67b6c02ce702694dd1576e71cdb15))
* **styles:** replace raw oklch values with Tailwind CSS color variables ([f0dc615](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f0dc615f13e6b4bdae5d5a7c71d2e7739e327467))
* **template:** rename {updatedAt} variable to {mtime} ([#354](https://github.com/kosukekoreyuki/prompt-line-plus/issues/354)) ([ed19e53](https://github.com/kosukekoreyuki/prompt-line-plus/commit/ed19e536d1072eeea3031f3260724de8989ae0d3))
* **tests:** cleanup post-migration issues found by code review ([2f70e59](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2f70e5906fa5d79e87778db891425bc88a64244c))
* **ui:** extract color resolution logic into reusable utility ([d331d51](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d331d51b634032556182adb346267ee89fb47ec3))


### Tests

* consolidate path and pattern fields in custom search configurations ([d6136f2](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d6136f289d1f26bbbce16922b0156ed1c23e7a5c))
* consolidate pattern field into path for custom search entries ([b3f340c](https://github.com/kosukekoreyuki/prompt-line-plus/commit/b3f340cb9b99aea0f90d5f7d685a6a60bfe4c96e))
* **highlight-utils:** migrate test environment configuration to Vitest ([fcd0165](https://github.com/kosukekoreyuki/prompt-line-plus/commit/fcd01658a3380824c51e4d11cee35f7d770d3ed8))
* **md-search-loader:** add tests for {dirname} template resolution ([441896b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/441896b1c54f203d72cda5deeb5d1bf768804d11))
* migrate from Jest to Vitest ([848450a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/848450a106cdd7fa1719bc4fdc5ccb5175ba64ac))
* mock console methods to suppress output during tests ([3b69e2b](https://github.com/kosukekoreyuki/prompt-line-plus/commit/3b69e2b2a381aea1e4a0a0e1e3e5a0d35b6f3ae4))
* **mocks:** simplify mock implementations to match actual usage ([986d055](https://github.com/kosukekoreyuki/prompt-line-plus/commit/986d055edee15d22931734999a6db586cf18e7f6))
* remove redundant test cases across multiple test suites ([4dfc3d5](https://github.com/kosukekoreyuki/prompt-line-plus/commit/4dfc3d521c1215a83cce6ac41a65a3271bb5e9e0))
* **renderer:** add missing mocks and fix window lifecycle test assertion ([d2e058e](https://github.com/kosukekoreyuki/prompt-line-plus/commit/d2e058e72732f51002ccda019c66357502f8c7e7))
* **renderer:** mock setAutoFormatManager on EventHandler ([231c87a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/231c87a30d93712ce0c6d33750269e7993fb11d0))
* **settings-cache-manager:** verify error is logged on API failure ([35ba787](https://github.com/kosukekoreyuki/prompt-line-plus/commit/35ba787a0f35ca9ecefa049bed83f73aab263dd9))
* **settings-manager:** update default settings test expectations ([a7d22dd](https://github.com/kosukekoreyuki/prompt-line-plus/commit/a7d22dd9ea0f51662eadabb31d0b64cabf8a2476))
* **settings:** update customSearch agent label and color assertions ([6545d30](https://github.com/kosukekoreyuki/prompt-line-plus/commit/6545d307c9f2a5240efee5e328d7dd69ab0095d2))
* **settings:** update plugin label and color assertions to match defaults ([2448bfa](https://github.com/kosukekoreyuki/prompt-line-plus/commit/2448bfa5c6ac65dbabedb37e70301d071ab060d3))
* simplify dirname resolution tests and consolidate test cases ([5035664](https://github.com/kosukekoreyuki/prompt-line-plus/commit/50356646e425c8d32938a2bb85c5b583d00ce84a))
* **template-resolver:** add tests for dirname template variable ([aacea67](https://github.com/kosukekoreyuki/prompt-line-plus/commit/aacea67facec33ea8b07bfaa192119651957e113))
* **unit:** restore and add missing critical unit tests ([f8bea0a](https://github.com/kosukekoreyuki/prompt-line-plus/commit/f8bea0a04c999e294a290b8e67e069e1c05df845))


### Build System

* **pnpm:** configure build script whitelist and ignore list ([33bca81](https://github.com/kosukekoreyuki/prompt-line-plus/commit/33bca81a30e82ffbd42740bd3614757fd54d3a01))


### Continuous Integration

* harden GitHub Actions workflows with security controls ([cd1dacf](https://github.com/kosukekoreyuki/prompt-line-plus/commit/cd1dacf0db2fac15c4d1176a613df9777dd5587b))
...
* **plugins:** plugin system with GitHub repo-based install and `@ref` support ([#303](https://github.com/nkmr-jp/prompt-line/issues/303)) ([3bf5265](https://github.com/nkmr-jp/prompt-line/commit/3bf5265))
* **plugins:** unify plugin commands into single CLI entry point (`prompt-line-plugin`) ([5467dfc](https://github.com/nkmr-jp/prompt-line/commit/5467dfc))
* **plugins:** support local repos without remote origin ([802c75a](https://github.com/nkmr-jp/prompt-line/commit/802c75a))
* **plugins:** support skills, agents, and references in agent-built-in YAML ([#310](https://github.com/nkmr-jp/prompt-line/issues/310)) ([071d21a](https://github.com/nkmr-jp/prompt-line/commit/071d21a))
* **plugins:** add pluginDescription field and show as comments in install output ([#288](https://github.com/nkmr-jp/prompt-line/issues/288)) ([4e2a9a1](https://github.com/nkmr-jp/prompt-line/commit/4e2a9a1))
* **plugins:** add plugin-based search source management ([#286](https://github.com/nkmr-jp/prompt-line/issues/286)) ([1c56057](https://github.com/nkmr-jp/prompt-line/commit/1c56057))
* **plugins:** plugin and settings format with hot reload ([#330](https://github.com/nkmr-jp/prompt-line/issues/330)) ([f988848](https://github.com/nkmr-jp/prompt-line/commit/f988848))
* **plugins:** color support, templates, and `{latest}` filter ([#308](https://github.com/nkmr-jp/prompt-line/issues/308)) ([4b7264f](https://github.com/nkmr-jp/prompt-line/commit/4b7264f))
* **custom-search:** add command stdout as search source (`sourceCommand` field) ([#313](https://github.com/nkmr-jp/prompt-line/issues/313)) ([20c7e02](https://github.com/nkmr-jp/prompt-line/commit/20c7e02))
* **settings:** add folder-based management for agentSkills and customSearch ([#293](https://github.com/nkmr-jp/prompt-line/issues/293)) ([3941c7b](https://github.com/nkmr-jp/prompt-line/commit/3941c7b))
* **history:** add iTerm2 session ID to history entries ([#301](https://github.com/nkmr-jp/prompt-line/issues/301)) ([4b68f8b](https://github.com/nkmr-jp/prompt-line/commit/4b68f8b))
* **tray:** show git hash and branch name in version display ([#287](https://github.com/nkmr-jp/prompt-line/issues/287)) ([599a042](https://github.com/nkmr-jp/prompt-line/commit/599a042))


### Bug Fixes

* **security:** replace execSync with execFileSync to prevent command injection ([068ae8b](https://github.com/nkmr-jp/prompt-line/commit/068ae8b))
* **plugins:** truncate long comments in plugin install output ([028d173](https://github.com/nkmr-jp/prompt-line/commit/028d173))
* **plugins:** increase comment truncation limit to 100 chars ([ba9d85e](https://github.com/nkmr-jp/prompt-line/commit/ba9d85e))
* **plugins:** improve plugin install reliability and hot reload ([#306](https://github.com/nkmr-jp/prompt-line/issues/306)) ([df455ae](https://github.com/nkmr-jp/prompt-line/commit/df455ae))
* **plugins:** use node wrapper for bin entry to resolve ts-node ([9530646](https://github.com/nkmr-jp/prompt-line/commit/9530646))
* **plugins:** copy excludeMarker field in plugin search entry parsing ([#291](https://github.com/nkmr-jp/prompt-line/issues/291)) ([bc16cee](https://github.com/nkmr-jp/prompt-line/commit/bc16cee))
* **built-in-commands:** restore builtInCommands setting support after plugin migration ([#300](https://github.com/nkmr-jp/prompt-line/issues/300)) ([c0151ad](https://github.com/nkmr-jp/prompt-line/commit/c0151ad))
* **file-opener:** detect project root and pass to editor on open ([#298](https://github.com/nkmr-jp/prompt-line/issues/298)) ([dcc95d3](https://github.com/nkmr-jp/prompt-line/commit/dcc95d3))
* **file-opener:** skip project root for non-editor apps ([#304](https://github.com/nkmr-jp/prompt-line/issues/304)) ([5d0611f](https://github.com/nkmr-jp/prompt-line/commit/5d0611f))
* **jq:** use raw() to avoid TypeError when select() filters out data ([#296](https://github.com/nkmr-jp/prompt-line/issues/296)) ([0631076](https://github.com/nkmr-jp/prompt-line/commit/0631076))
* **custom-search:** fix `{args.key}` template resolution ([#334](https://github.com/nkmr-jp/prompt-line/issues/334)) ([a27dde1](https://github.com/nkmr-jp/prompt-line/commit/a27dde1))
* **custom-search:** fix PATH resolution for sourceCommand ([#335](https://github.com/nkmr-jp/prompt-line/issues/335)) ([17acc55](https://github.com/nkmr-jp/prompt-line/commit/17acc55))


### Performance Improvements

* **cache:** conditional invalidation and prefetch for input completion ([#297](https://github.com/nkmr-jp/prompt-line/issues/297)) ([e024d49](https://github.com/nkmr-jp/prompt-line/commit/e024d49))
* **plugins:** lazy-load plugin-install module in CLI dispatcher ([65eae86](https://github.com/nkmr-jp/prompt-line/commit/65eae86))


### Refactoring

* **built-in-commands:** rename built-in-commands to agent-built-in ([#302](https://github.com/nkmr-jp/prompt-line/issues/302)) ([a194626](https://github.com/nkmr-jp/prompt-line/commit/a194626))
* **plugins:** migrate bundled plugins to external repo ([prompt-line-plugins](https://github.com/nkmr-jp/prompt-line-plugins)) ([#305](https://github.com/nkmr-jp/prompt-line/issues/305)) ([3eda02b](https://github.com/nkmr-jp/prompt-line/commit/3eda02b))
* **plugins:** migrate built-in-commands to plugin system and reorganize directory structure ([#292](https://github.com/nkmr-jp/prompt-line/issues/292)) ([6c2ead2](https://github.com/nkmr-jp/prompt-line/commit/6c2ead2))
* **config:** standardize on .yaml extension with .yml fallback ([#309](https://github.com/nkmr-jp/prompt-line/issues/309)) ([1ca2bf8](https://github.com/nkmr-jp/prompt-line/commit/1ca2bf8))
* remove dead code with knip (benchmarks, rate-limiter, handler-utils, ui-manager) ([#335](https://github.com/nkmr-jp/prompt-line/issues/335)) ([17acc55](https://github.com/nkmr-jp/prompt-line/commit/17acc55))


### Documentation

* new bilingual docs (`docs/en/`, `docs/ja/`) for migration, plugins, and settings ([#333](https://github.com/nkmr-jp/prompt-line/issues/333)) ([b5f3db2](https://github.com/nkmr-jp/prompt-line/commit/b5f3db2))
* update README overview and README_ja for clarity and improved feature explanation ([b36a8c3](https://github.com/nkmr-jp/prompt-line/commit/b36a8c3))
* add icon documentation ([#334](https://github.com/nkmr-jp/prompt-line/issues/334)) ([a27dde1](https://github.com/nkmr-jp/prompt-line/commit/a27dde1))
* update PR guidelines with develop branch merge strategy ([5e9e97b](https://github.com/nkmr-jp/prompt-line/commit/5e9e97b))


### Miscellaneous Chores

* revert from Changesets to Release Please for release automation ([c0f3b45](https://github.com/nkmr-jp/prompt-line/commit/c0f3b45))
* remove unused Serena project configuration ([f7f47f7](https://github.com/nkmr-jp/prompt-line/commit/f7f47f7))
